      ...
      <div className="admin-content">
        ...
        <form onSubmit={handleSubmit} className="admin-form">
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              <label>SKU</label>
              <input type="text" className="form-input" value={form.sku} onChange={e => setForm({...form, sku: e.target.value})} placeholder="e.g., SF-001" />
            </div>
          </div>

          <div className="form-group">
            <label>Short Description</label>
            <input type="text" className="form-input" value={form.short_description} onChange={e => setForm({...form, short_description: e.target.value})} placeholder="Brief description for product cards" />
          </div>

          <div className="form-group">
            <label>Full Description</label>
            <textarea className="form-input" value={form.description} onChange={e => setForm({...form, description: e.target.value})} rows={6} placeholder="Detailed product description..." />
          </div>
          ...
          <div className="image-upload-area" onClick={() => fileInputRef.current?.click()}>
            ...
            <p>{uploading ? 'Uploading...' : 'Click to upload images (multiple allowed)'}</p>
