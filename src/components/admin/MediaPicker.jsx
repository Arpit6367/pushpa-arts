    ...
    <div className="fixed inset-0 z-[5000] flex items-center justify-center p-4 sm:p-6 md:p-10">
      ...
      <div className="relative bg-white w-full max-w-5xl h-full max-h-[85vh] rounded-[32px] shadow-2xl flex flex-col overflow-hidden border border-black/10">
        ...
        <div className="px-8 py-6 border-b border-black/5 flex items-center justify-between bg-white sticky top-0 z-10">
          ...
          <button onClick={onClose} className="w-10 h-10 rounded-full hover:bg-black/5 flex items-center justify-center text-xl transition-colors border-none cursor-pointer">✕</button>
        </div>
              ...
              {uploading ? (
                ...
                <>
                  ...
                  <div className="mt-10 flex gap-4">
                     <button className="bg-[#0071e3] text-white px-10 py-4 rounded-2xl font-bold text-sm hover:bg-[#0071e3]/90 transition-all shadow-xl shadow-[#0071e3]/25 border-none cursor-pointer">Choose Files</button>
                  </div>
